import { AccountWallet, CompleteAddress, DebugLogger } from '@aztec/aztec.js';
import { Timer } from '@aztec/foundation/timer';
import { TokenContract } from '@aztec/noir-contracts.js';

import { jest } from '@jest/globals';

import { publicDeployAccounts, setupIntegrationTest } from './fixtures/utils.js';
import { TokenSimulator } from './simulators/token_simulator.js';

const TIMEOUT = 100_000;

describe('e2e_integration', () => {
  ...
  beforeAll(async () => {
    ({ teardown, logger, wallets, accounts } = await setupIntegrationTest(3));
