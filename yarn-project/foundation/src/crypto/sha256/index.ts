...
import { ch32, g0_256, g1_256, maj32, s0_256, s1_256 } from './common.js';
import { sum32, sum32_4, sum32_5 } from './utils.js';
...
// Extracted from hash.js, but modified to take in an initial state to operate on
export const sha256_compression = (state: Uint32Array, inputs: Uint32Array) => {
